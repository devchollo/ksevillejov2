...
const Portfolio = () => {
  ...
  const [companyLogos, setCompanyLogos] = useState([
    { name: 'Supreme by SeatSavers', url: 'https://seatsavers.com/', logo: 'https://f005.backblazeb2.com/file/onestopmp3pi/embed_1761706766635_9df8cc6406707735.png' },
  ...
  const projects = [
    ...
    },
    {
      ...
      description: 'Full-featured online shopping platform with payment integration, inventory management, and advanced analytics dashboard.',
  ...
  const workHistory = [
    {
      ...
      description: 'Maintaining hundreds of websites under Network Solutions. Specializing in custom code modifications, plugin management, and resolving complex technical issues.',
      achievements: ['Maintained 200+ client websites', 'Reduced resolution time by 40%', 'Implemented automated monitoring systems']
    },
    {
      period: 'January 2024 - April 2024',
      company: 'TDCX (Apple Inc.)',
      role: 'Technical Support Specialist',
      description: 'Provided technical support for iOS, macOS, and watchOS devices. Excelled in troubleshooting and hardware diagnostics.',
      achievements: ['95% customer satisfaction rating', 'Expert in iOS ecosystem', 'Genius Bar coordination specialist']
    },
    {
      period: '2024',
      company: 'Cognizant',
      role: 'IT Help Desk',
      description: 'Assisted Family Dollar Stores across the U.S. with technical support for networks, servers, registers, and all MSP-related infrastructure.',
      achievements: ['Managed 500+ support tickets monthly', 'Network troubleshooting expert', 'Hardware repair coordination']
    },
    {
      period: '2022 - 2024',
      company: 'Concentrix (Intuit QuickBooks)',
      role: 'Technical Associate',
      description: 'Assisted customers across the U.S. with QuickBooks Online and Desktop. Specialized in bookkeeping, reconciliation, and financial reporting.',
      achievements: ['Resolved 1000+ technical issues', 'Bookkeeping expert', '98% issue resolution rate']
    }
  ];
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const sections = ['home', 'about', 'techstack', 'projects', 'work', 'testimonials', 'contact'];
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <div className="inline-flex items-center gap-2 bg-amber-100 px-4 py-2 rounded-full">
                ...
                <span className="text-sm font-medium text-amber-900">Available for Opportunities</span>
              </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <p className="text-lg text-stone-600 leading-relaxed">
                I'm Kent, a UI/UX and brand designer passionate about creating visually compelling and user-friendly digital experiences.
              </p>
              <p className="text-lg text-stone-600 leading-relaxed">
                With a keen eye for aesthetics and a deep understanding of user behavior, I design brands and interfaces that not only look great but also resonate with audiences.
              </p>
              <p className="text-lg text-stone-600 leading-relaxed">
                Whether it's building a brand identity from the ground up or refining a digital product for seamless usability, I blend strategy, creativity, and functionality to bring ideas to life.
              </p>
            ...
            <div className="grid grid-cols-2 gap-6">
              {[
                { icon: Layout, title: 'User-Centered Design', desc: 'Intuitive interfaces tailored for your audience' },
                { icon: Award, title: 'Brand Identity', desc: 'Unique brand strategies that stand out' },
                { icon: Code, title: 'Responsive & Modern UI', desc: 'Optimized for all devices' },
                { icon: Wrench, title: 'Seamless Prototyping', desc: 'Bring ideas to life before development' }
              ].map((item, idx) => (
                <div
                  key={idx}
      ...
      <section id="techstack" className="py-20 px-4 bg-stone-900 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-4 text-white">Tech Stack & Skills</h2>
                    ...
                    <div className="relative w-16 h-16 mb-2">
                      <svg className="transform -rotate-90 w-16 h-16">
                        ...
                        <circle
                          ...
                          strokeDashoffset={`${2 * Math.PI * 28 * (1 - tech.level / 100)}`}
          ...
          <div className="grid md:grid-cols-4 gap-6 mt-16">
            {[
              ...
              <div key={idx} className="bg-stone-800/50 backdrop-blur-sm border border-stone-700/50 rounded-2xl p-6 text-center">
      ...
      <section id="projects" className="py-20 px-4 bg-stone-900 text-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-stone-400 max-w-2xl mx-auto">
              Explore my recent work and discover how I transform visions into reality
            </p>
          </div>
              ...
              {projects.map((project, idx) => (
                <div
                  ...
                  className={`transition-all duration-700 ${
                    idx === activeProject ? 'opacity-100 relative' : 'opacity-0 absolute inset-0'
                  }`}
                >
                  <div className="grid md:grid-cols-2 gap-8 bg-stone-800 rounded-3xl overflow-hidden">
                    ...
                    <div className="p-8 md:p-12 flex flex-col justify-center">
                      ...
                      <p className="text-stone-400 mb-6 text-lg">{project.description}</p>
                      <div className="flex flex-wrap gap-2 mb-6">
                        {project.tech.map((t) => (
                          <span key={t} className="px-4 py-2 bg-stone-700 rounded-full text-sm">
                            {t}
                          </span>
                        ))}
                      </div>
              ...
              >
                <div className="flex flex-col md:flex-row md:items-start gap-6">
                  ...
                  <div className="flex-grow">
                    ...
                    <p className="text-stone-600 mb-4 text-lg">{job.description}</p>
                    <div className="space-y-2">
                      <p className="font-semibold text-stone-900">Key Achievements:</p>
            ...
            <div className="p-8">
              <div className="flex justify-between items-start mb-6">
                <div>
                  ...
                  <p className="text-stone-600">Your feedback helps me improve and grow</p>
                </div>
                <button
              ...
              <form onSubmit={handleTestimonialSubmit} className="space-y-6">
                  ...
                  <div className="flex gap-2">
                    {[1, 2, 3, 4, 5].map((star) => (
                      ...
                      >
                        <svg
                          className={`w-10 h-10 ${
                            star <= testimonialForm.rating ? 'text-amber-500' : 'text-stone-300'
                          }`}
                          fill="currentColor"
                          viewBox="0 0 20 20"
                        >
                ...
                <p className="text-xs text-stone-500 text-center">
                  Your review will be reviewed and approved before being displayed publicly.
                </p>
              </form>
            </div>
          </div>
